...
import { Calendar, Copy, Check, FileCheck, Upload } from "lucide-react";
              ...
              <div className="p-2 flex justify-between">
                ...
                (campaign as any).userRewards?.some((r: any) => r.status === 'PROOF_REQUIRED' && !r.proofSubmittedAt) ? (
                  <button
                    ...
                    className="rounded-md px-4 py-2 bg-[#ECF3FF] text-primary hover:bg-[#d9e8ff] flex items-center gap-2"
                  >
                    <Upload size={16} />
