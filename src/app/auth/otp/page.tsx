  ...
  return (
    <AuthLayout>
      <form className="w-full max-w-xl mt-12 md:mt-20" onSubmit={handleSubmit}>
        ...
        <h2 className="text-heading text-2xl font-semibold mb-2">
          Check your email
        </h2>
        ...
        <div className="flex w-full gap-2 lg:gap-4 mb-4">
          {otp.map((digit, idx) => (
            <input
              ...
              inputMode="numeric"
              maxLength={1}
              className={`flex-1 min-w-0 h-12 md:h-14 lg:h-16 rounded-md border text-center text-2xl font-medium focus:outline-none focus:ring-2 focus:ring-primary transition ${
        ...
        <div className="flex gap-2 mb-6 text-body text-base">
          Code expires in{" "}
          <p className="font-medium">00:{timer.toString().padStart(2, "0")}</p>
        </div>
